...
const productArticlePlans: Record<string, string[]> = {
  ...
  "sanei-drain-cleaner-pr871": ["water-leak", "drain-hose", "call-contractor"],
...
const productRelatedPlans: Record<string, string[]> = {
  ...
  "drain-pump": ["sanei-drain-cleaner-pr871", "drain-insect-cap"],
  "sanei-drain-cleaner-pr871": ["drain-pump", "drain-insect-cap"],
  "drain-insect-cap": ["drain-pump", "sanei-drain-cleaner-pr871"],
