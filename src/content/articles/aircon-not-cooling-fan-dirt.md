...
![冷房と風量の設定、フィルター、停止中の吹き出し口、運転後の温度を順番に確認する図解](/images/articles/aircon-fan-self-check.webp)
...
![家庭ではフィルターと外装を掃除し、送風ファンを含む内部洗浄はプロへ任せる境界の図解](/images/articles/aircon-cleaning-safety-boundary.webp)
...
この記事の下に、提携済みサービスだけを使った5タイプの比較を掲載しています。さらに詳しい料金、対応地域、追加料金、補償の見方は、[エアコンクリーニング業者の選び方とおすすめ比較](/articles/aircon-cleaning-company-guide/)で確認できます。
